...
- Copy the **knowledge capture prompt** code block from the mcp-pusher README (`#knowledge-capture-prompt`) before context compaction — agent gathers git context, synthesizes lessons, runs `mcp:append`
