...
- Paste **`stubs/knowledge-capture-prompt.txt`** (see mcp-pusher README `#knowledge-capture-prompt`) before context compaction — agent gathers git context, synthesizes lessons, runs `mcp:append`
