---
name: mcp-session-capture
description: Capture session knowledge with mcp-pusher using mcp:append and mcp:push. Use before context compaction or at session end on Laravel projects with ashwinmram/mcp-pusher.
---
